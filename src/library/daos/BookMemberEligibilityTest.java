...
public class BookMemberEligibilityTest {
	...
	public static void main(String[] args) {// Start
		...
		if (member.equalsIgnoreCase("member1")) {
			...
			System.out.println("Remaining balance is : " + member1);// printing
																	// the
																	// result
																	// value
