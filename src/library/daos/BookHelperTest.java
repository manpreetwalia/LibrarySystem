...
// Create object book1 of class IBook, makebook
		...
		// Test the function getAuthor()
				System.out.println("The Name of author is:    " + book1.getAuthor());// display output
				
		// Test the function getTitle()
				
				System.out.println("The title of book is:    " + book1.getTitle()); // display output
				
		// Test the function getCallNumber()
				
				System.out.println("The callNumber of book is:   " + book1.getCallNumber()); // display output
		...
		if(Author.equalsIgnoreCase("Y. Liang") && ID==123); // checks the condition
		System.out.println(" The author of book is : Y. Liang"); // display output
