...
// Start of main function
	...
	public static void main(String[] args)
	{
		...
		Scanner in = new Scanner(System.in);  //Taking the input as Author
	      ...
	      else if(Author.equalsIgnoreCase("JK Rowling") && Title.equalsIgnoreCase("Harry Potter7"))// checks the condition
	      {
	      ...
	      {
	    	  System.out.println("Either of the values do not match our records.Pls enter correct values!");// display error msg on screen
	      }
