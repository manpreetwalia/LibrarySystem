...
public class LoanHelperTest {
     ...
     public static void main(String[] args){
           ...
           Member borrower2 = new Member("Manpreet", "Walia", "54556789", "manpreetwalia02@gmail.com", 1781);
           ...
           System.out.println("Loan is " + book3.getLoan());

           System.out.println("Book is " + book3.getState());
